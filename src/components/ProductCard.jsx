...
const ProductCard = ({ bagImage, title, amount }) => {
  return (
    <div  className="card w-[90%] h-[50vh] md:w-[40vw] lg:w-[23vw]  md:h-[65vh]  border-[2.5px] border-[#9694949d] rounded-xl pb-4 md:pb-[1vw] bg-[#D3DEDC] flex-shrink-0 cursor-pointer transition-all duration-300 ease-in-out hover:bg-black hover:text-white hover:scale-105 hover:border-none">
      <div className='w-full h-[72vw] md:h-[40vh]  flex items-center justify-center'>
      ...
      <div className='w-full flex items-center justify-center mt-4 md:mt-0'>
        <div className='w-[90%] md:w-[80%] flex items-center justify-between '>
          <h1 className='font-bold text-2xl md:text-[1.3vw]'>{title}</h1>
          <h1 className='font-bold text-2xl md:text-[1.3vw]'>₹{amount}</h1>
        </div>
      </div>
