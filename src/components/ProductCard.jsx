...
const ProductCard = ({ bagImage, title, amount }) => {
  return (
    <div  className="card w-[90%] h-[60vh] md:w-[40vw] lg:w-[23vw]  md:h-[65vh]  border-[2.5px] border-[#9694949d] rounded-xl pb-4 md:pb-[1vw] bg-[#D3DEDC] flex-shrink-0 cursor-pointer transition-all duration-300 ease-in-out hover:bg-black hover:text-white hover:scale-105 hover:border-none">
