      ...
      <div className='w-full h-[88vh]'>
        <div className='w-full h-full flex justify-center relative'>
          ...
          <div className='overflow-hidden'>
            ...
            <div className='overflow-hidden'>
              <h1 className='Consolas heading text-[21vw] md:text-[30vw] lg:text-[20vw]  text-[#385154] leading-none tracking-tight' style={{ WebkitFontSmoothing: 'antialiased', MozOsxFontSmoothing: 'grayscale' }}>
                BACKPACK
              </h1>
            </div>
          </div>
