  ...
  return (
    <div className='w-full min-h-full bg-[#D3DEDC] flex flex-col pb-[25vw] md:pb-5'>
      ...
      <div className='w-full md:h-[80vh] flex flex-col gap-10 justify-center items-center relative flex-shrink-0 md:flex-row md:items-baseline '>
        ...
        <button style={{ boxShadow: "0 5px 15px rgba(0, 0, 0, 0.35)" }}  className='absolute px-5 bg-[#385154]  text-white rounded-full py-3 text-sm md:bottom-6 left-[26%] -bottom-[5%] md:left-[44%] transition-all duration-300 ease-in-out hover:bg-[#000000da] hover:text-white hover:scale-105'> View All Our Products</button>
      </div>
    </div>
  )
}
